...
router.get("/:inviteCode/initiatives", async(req, res)=>{
    const inviteCode = req.params.inviteCode;
    const foundInitiatives = await Organisation.findOne({inviteCode:inviteCode}).populate("initiativeList")
    res.json(foundInitiatives.initiativeList)
})

router.get("/:inviteCode/initiativeId", async (req, res)=>{
