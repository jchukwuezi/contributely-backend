...
const getCausesByInterests = async (url) => {
    ...
    .then(async (res) => {
        ...
        const project1Obj = {
            ...
            id: project1["id"],
            url: getProjectUrl(specificIdUrl(project1["id"])).then((res) =>{
                return res
            })
        ...
        const project2Obj = {
            ...
            id: project2["id"],
            url:getProjectUrl(specificIdUrl(project2["id"])).then((res)=>{
                return res
            })
        }
        ...
        const project3Obj = {
            ...
            id: project3["id"],
            url: getProjectUrl(specificIdUrl(project3["id"])).then((res)=>{
                return res
            })
        }
 ...
 */
 ...
 const getProjectUrl = async(url) =>{
    ...
    .then((res) => {
        return res["project"]["projectLink"]
    })
    ...
    .then((res)=>{
        ...
        projectUrl = res["project"]["projectLink"]
        /*
