...
const extractPageInfo = async (...urls) => {
    let causeObj = {}
    urls.forEach((url)={
        const data = await fetch('https://www.gofundme.com/f/zoes-wish-to-chew-chat?qid=5ad33c6afdae5bfb06c7cd3eb88b5d30')
        const pageBody = await data.text()
        const $ = cheerio.load(pageBody)
        ...
        const url = 'https://www.gofundme.com/f/zoes-wish-to-chew-chat?qid=5ad33c6afdae5bfb06c7cd3eb88b5d30'
